    ...
    return (
      <div className={cn(
        ...
        <div className="relative h-24 w-24">
            <div className="absolute -inset-0.5 animate-spin rounded-full bg-gradient-to-r from-primary to-accent" />
            <div className="relative flex h-full w-full items-center justify-center rounded-full bg-neutral-900">
                <Image 
